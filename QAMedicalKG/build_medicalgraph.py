...
class MedicalGraph:
    def __init__(self):
        ...
        self.g = Graph("http://localhost:7474", username="neo4j", password="UCAS251340")
        #self.g = Graph("http://localhost:7687", auth=("neo4j","neo4j"))
